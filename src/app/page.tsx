...
import { Globe, Truck, ShieldCheck, Anchor, FileCheck, Award, ArrowRight, Warehouse, Box, HardHat, TrendingUp, Clock } from 'lucide-react';
  ...
  return (
    <main className="flex-col min-h-screen bg-white">
      ...
      <section className="relative h-[580px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 w-full max-w-6xl px-4 grid md:grid-cols-2 gap-12 items-center mt-4">
          ...
          <div className="hidden md:block relative">
            <div className="bg-slate-900 border-t-4 border-yellow-500 p-6 shadow-2xl max-w-md ml-auto ring-1 ring-white/10">
      ...
      {/* 3. GRID DE SERVIÇOS (MANTIDO) */}
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
           <div className="mb-10 border-l-8 border-slate-900 pl-6 flex justify-between items-end">
              <div>
              ...
              <Link href="/services" className="hidden md:flex items-center gap-2 text-slate-900 font-bold text-xs uppercase border-b-2 border-yellow-500 pb-1 hover:text-yellow-600 transition-colors tracking-widest">
      ...
      {/* 4. DIFERENCIAIS TÉCNICOS (MANTIDO) */}
      <section className="py-20 bg-white border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-16 items-center">
                <div className="relative h-[500px] rounded-sm overflow-hidden shadow-2xl ring-1 ring-slate-900/10">
                    ...
                    <div className="absolute bottom-0 left-0 bg-slate-900 p-8 w-3/4 border-t-4 border-yellow-500">
      ...
      {/* 5. ESTATÍSTICAS (COMPACTADO E SÓBRIO) */}
      {/* Reduzido de py-16 para py-8 e tamanho das fontes diminuído */}
      ...
      {/* SEÇÃO DE CLASSES DE RISCO FOI REMOVIDA CONFORME PEDIDO */}
...
function StatItem({ number, label, highlight }: { number: string, label: string, highlight?: boolean }) {
    return (
        <div className="flex flex-col items-center justify-center p-2"> {/* Padding reduzido */}
            {/* Texto reduzido de 5xl para 3xl/4xl */}
